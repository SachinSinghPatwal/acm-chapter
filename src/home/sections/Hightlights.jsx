...
function HighlightHeader() {
  return (
    <div className="w-full flex px-max items-center gap-4 ">
      <motion.h1
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ delay: 0.1, duration: 0.3, ease: "easeInOut" }}
        className="font-black w-fit font-bebas-neue text-heading relative whitespace-nowrap"
      >
        Our <AuroraText>Highlights</AuroraText>
      </motion.h1>
      <div className="h-full w-full flex flex-col gap-2 md:gap-3 items-center justify-center">
        <motion.span
