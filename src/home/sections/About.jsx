...
export default function AboutSection() {
    return (
      <div className='min-h-screen bg-neutral-50 relative flex flex-col gap-14 py-20 xl:py-32'>
        ...
        <span className="h-1 w-40 md:w-70 bg-red-500 rounded-full absolute inset-y-0 my-auto left-30 md:left-60"  />
        ABOUT US
        <span className="h-1 w-40 md:w-70 bg-red-500 rounded-full absolute inset-y-0 my-auto right-30 md:right-60" />
        </h1>
        ...
        <div className='relative w-full 2xl:mt-6'>
          ...
          <div className='absolute inset-0  bg-gradient-to-b from-neutral-50 via-neutral-50/0 to-neutral-50/5 w-full z-200'>
          </div>
        </div>
      </div>
    )
