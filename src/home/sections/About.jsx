...
export default function AboutSection() {
    return (
      <div className='min-h-screen bg-neutral-50 relative flex flex-col gap-20 py-20 xl:py-32'>
        <h1 className='text-7xl font-black text-black/85  text-center'>ABOUT US</h1>
        <p className=' text-sm max-w-[120rem] mx-auto lg:text-lg xl:text-xl 2xl:text-2xl text-center text-black/70 px-[5dvw]'>
