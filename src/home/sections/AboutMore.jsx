  ...
  return (
    <div className='py-4 pb-16 px-max flex flex-col gap-20 mx-auto'>
      <div className='flex flex-col gap-8 px-max '>
        ...
        <p className='text-xl  font-inter max-w-4xl text-neutral-600'>Our programmes are designed for those who want to break the mould. From radical architecture to self-sufficient design, we cover the subjects that matter, using the tools of tomorrow to build a better today.</p>
      </div>
